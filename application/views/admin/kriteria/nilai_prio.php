...
<div class="row">
	...
	<form action="<?php echo site_url('admin/kriteria/save_prioritas');?>" method="post" enctype="multipart/form-data">
		<div class="table-responsive">
		<table width="100%" class="table table-striped table-bordered">
			<thead>
				<tr>
					...
					foreach ($kriteria as $key => $value) {
						echo "<th>$value->nama</th>";
						echo '<input type="hidden" name="kriteria[]" value="'.$value->id_kriteria.'">';
					}
					?>
		...
		if($ahp3['cr'] <= 0.1){
			...
			echo '<input type="submit" name="" class="btn btn-dark" value="Simpan Hasil"><br><br>';
		}else{
			echo '<p style="color:red">TIDAK KONSISTEN</p>';
			echo "<a href='".site_url('admin/kriteria/analisa')."' class='btn btn-danger'>Ulangi Perhitungan</a><br><br>";
		}
		?>
